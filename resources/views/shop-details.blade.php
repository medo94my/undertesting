            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        ...
                        <div class="product__details__pic__slider owl-carousel">
                            <img data-imgbigurl="{{asset($item->image)}}"
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        @if ($item->discount <= 0 )
                        <div class="product__details__price">${{$item->price/100}}</div> 
                        @else
                        <div class="product__discount__item__text text-left">
                        <div class="product__item__price  product__details__price">${{round(($item->price/100)*(100-($item->discount)))/100}} <span>${{$item->price /100}}</span></div>
                            </div>
                        ...
                        <a href="#" onclick="add({{$item->id}},event)" class="primary-btn">ADD TO CARD</a>
                        <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                        <ul>
                            <li><b>Availability</b> <span>{{  $item->stock >0 ? 'In Stock' : 'Out Stock' }}</span></li>
                            <li><b>Shipping</b> <span>01 day shipping. <samp>Free pickup today</samp></span></li>
                            <li><b>Weight</b> <span>{{$item->weight/1000}} kg</span></li>
                            <li><b>Share on</b>
                                <div class="share">
