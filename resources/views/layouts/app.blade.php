...
<head>
    ...
    <meta name="description" content="Go where your heart beats with Martify Store! Shop the healthy products | Best Prices ➤ Fast Delivery ✈">
    <meta name="keywords" content="Martify, Vegetables, Fruits, html">
    ...
    <link href="https://fonts.googleapis.com/css?family=Nunito" rel="stylesheet">
     <!-- Google Font -->
     <link href="http://fonts.googleapis.com/css2?family=Cairo:wght@200;300;400;600;900&display=swap" rel="stylesheet">
   
     <script src="https://kit.fontawesome.com/52d77073d0.js" crossorigin="anonymous"></script>
    <title>{{ config('app.name', 'Martify') }}</title>
